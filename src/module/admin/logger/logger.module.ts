...
@Module({
	...
	providers: [LoggerService, TagLoggerService, UserLoggerService, ProjectLoggerService],
	controllers: [LoggerController],
	exports: [LoggerService, TagLoggerService, UserLoggerService, ProjectLoggerService]
})
